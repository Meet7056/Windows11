...
function Podcasts({ data }: { data: Props }) {
	...
	return (
		<>
			<Head>
				<title>MEET - Podcasts</title>
				<link
					rel="canonical"
					href="https://www.MEET.dev/explorer/favorites"
				/>
				...
				{/* OpenGraph */}
				<meta property="og:title" content="MEET - Podcasts" />
				<meta
					property="og:url"
					content="https://www.MEET.dev/explorer/podcasts"
				/>
				<meta
