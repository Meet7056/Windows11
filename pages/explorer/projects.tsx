	...
	return (
		<>
			<Head>
				...
				<link
					rel="canonical"
					href="https://www.MEET.dev/explorer/projects"
				/>
				...
				{/* OpenGraph */}
				<meta property="og:title" content="MEET - Quick access" />
				<meta
					property="og:url"
					content="https://www.MEET.dev/explorer/projects"
				/>
				<meta
...
export async function getStaticProps() {
	const res = await fetch(`https://api.github.com/users/Meet7056/repos`);
