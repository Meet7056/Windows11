...
function ThisPC() {
	...
	return (
		<>
			<Head>
				<title>MEET - This PC</title>
				<link
					rel="canonical"
					href="https://www.MEET.dev/explorer/this-pc"
				/>
				...
				{/* OpenGraph */}
				<meta property="og:title" content="MEET - This PC" />
				<meta
					property="og:url"
					content="https://www.MEET.dev/explorer/this-pc"
				/>
				<meta
